...
import com.eventledger.gateway.dto.FieldError;
import com.eventledger.gateway.dto.ValidationErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    // these arrive as InvalidFormatException BEFORE Bean Validation, so we map them to the
    // same {"errors":[...]} shape clients expect for all 400 responses.
